                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Agregar Patrocinador</h2>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <form class="p-20" method="POST" action="{{ url('admin/refers/') }}" accept-charset="UTF-8" enctype="multipart/form-data">
                                        {{ csrf_field() }}
            
                                        @include ('Admin.Refers.form', ['formMode' => 'create'])
