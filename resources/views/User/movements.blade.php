...
<head>
    ...
    <title>INNOVACIÓN FINANCIERA | Movimientos</title>
...
<body>
    <nav class="navbar navbar-dark sticky-top bg-blue2 flex-md-nowrap p-0 shadow">
        ...
        {{-- <a class="flecha-atras" href="#"><img src="img/regresar.png"></a> --}}
        <h1 class="mx-auto mt-5">Movimientos</h1>
    ...
    <script type="text/javascript">
        $("#movements").last().addClass("active");
    </script>
</html>
