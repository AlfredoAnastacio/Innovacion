            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-3">
                <div class="">
                    <div class="contenido pt-5 ">
                        ...
                        <div class=" ">
                            <form method="POST" action="{{ route('virtualWallet.store') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                @if ($wallet)
                                    <div class="cuenta mx-auto">
                                        <div class="row px-3 mb-4 burbuja mx-1 imp-shadow">
                                            ...
                                            <div class="col-10">
                                                <input type="text" class="griz mb-0 border-0 fwl p-13 col-md-12" name="ewallet" value="{{ $wallet->wallet }}" disabled>
                                            </div>
                                        </div>
